 ...
 */
public class TelaGerenciarSintomas extends javax.swing.JFrame {
    ...
    public void MostrarSintomas() {
        ...
        bdao.BuscarSintomasAtivos().forEach((b) -> {
    ...
    public void Salvar() {
        ...
        Sintomas_Ctrl ctrl = new Sintomas_Ctrl();

        if (TxtDescAlteracao.getText() == null || TxtDescAlteracao.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Informe um Sintoma!!");
        } else {
            a.setDesc_Sintoma(TxtDescAlteracao.getText());
            if (Inativo.isSelected()) {
                a.setStatus_Sintoma(false);
            } else {
                a.setStatus_Sintoma(true);
            }
            ...
            Sintomas_Dao udao = new Sintomas_Dao();
            udao.BuscarUltmoSintoma().forEach((u) -> {

                Cod_registro = u.getCod_Sintoma();
            });
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Descrição Sintoma");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciarSintomas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGerenciarSintomas().setVisible(true);
            }
        });
    }
