...
import Controle.AlteracoesTC_Ctrl;
 ...
 */
public class TelaGerenciarAlteracoesTC extends javax.swing.JFrame {
    ...
    public TelaGerenciarAlteracoesTC() {
        initComponents();
    ...
    //Carrega Tabela
    public void MostrarAlteracaoTC() {
        ...
        bdao.BuscarAlteracoesTCAtivos().forEach((b) -> {
    ...
    public void Salvar() {
        AlteracoesTC a = new AlteracoesTC();
        AlteracoesTC_Ctrl ctrl = new AlteracoesTC_Ctrl();
        ...
        if (TxtDescAlteracao.getText() == null || TxtDescAlteracao.getText().equals("")) {
            ...
            a.setDesc_TC(TxtDescAlteracao.getText());
            if (Inativo.isSelected()) {
                a.setStatus_TC(false);
            } else {
                a.setStatus_TC(true);
            }
            ...
            AlteracoesTC_Dao udao = new AlteracoesTC_Dao();
            udao.BuscarUltimoAlteracoesTC().forEach((u) -> {

                Cod_registro = u.getCod_TC();
            });
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Descrição Alteração TC");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciarAlteracoesTC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGerenciarAlteracoesTC().setVisible(true);
            }
        });
    }
